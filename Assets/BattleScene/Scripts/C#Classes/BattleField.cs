...
/*    AnAction roundStartEvent;
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity. MaxHPFilter_WhenCalcSkill(buff,whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.ATKFilter_WhenCalcSkill(buff,whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.DEFFilter_WhenCalcSkill(buff, whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.SATKFilter_WhenCalcSkill(buff, whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.SDEFFilter_WhenCalcSkill(buff, whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.SPDFilter_WhenCalcSkill(buff, whosParamCalc, sUnit, useSkill, oUnit,this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.TypeFilter_WhenCalcSkill(buff, whosParamCalc, sUnit, useSkill, oUnit, this),
    ...
    public List<ParamFilter<List<BattleUnit>>> OUnitsFilter_WhenCalcSkill(BattleUnit sUnit, SkillSubst useSkillSubst)
    {
        ...
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.OUnitsFilter_WhenCalcSkill(buff, sUnit, useSkillSubst, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.skillEfcFuncFilter_WhenCalcSkill(buff, sUnit, useSkillSubst, oUnit, this),
    ...
    public  List<ParamFilter< ExSkillEfc>> ExSkillEfcFilter( BattleUnit sUnit, SkillSubst useSkill, BattleUnit oUnit)
    {
        ...
        filters= makeFilter_BuffAndAbility((buff) => buff.identity.ExSkillEfcFilter(buff, sUnit, useSkill, oUnit, this),
    ...
    public virtual List<ParamFilter<AcSkillEfc>> AcSkillEfcFilter( BattleUnit sUnit, SkillSubst useSkill, BattleUnit oUnit)
    {
        ...
        filters= makeFilter_BuffAndAbility((buff) => buff.identity.AcSkillEfcFilter(buff, sUnit, useSkill, oUnit, this),
    ...
    public virtual List<ParamFilter<(int spd, int actPriority)>> SPDAndPriorityFilter_WhenSort(BattleUnit sUnit, SkillSubst useSkill ,BattleUnit oUnit)
    {
        ...
        filters= makeFilter_BuffAndAbility((buff)=>buff.identity.SPDAndPriorityFilter_WhenSort(buff, sUnit, useSkill, oUnit, this),
    ...
    public List<ParamFilter<int>> AfterRoundEventFilter()
    {
        ...
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.AfterRoundEventFilter(buff, this),
    ...
    {
        List<ParamFilter<int>> filters = new List<ParamFilter<int>>();
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.BeforeRoundEventFilter(buff, this),
    ...
    {
        List<ParamFilter<int>> filters = new List<ParamFilter<int>>();
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.BeforeTurnEventFilter(buff, whosTurn, this),
    ...
    {
        List<ParamFilter<int>> filters = new List<ParamFilter<int>>();
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.AfterTurnEventFilter(buff, whosTurn, this),
    ...
    public virtual List<ParamFilter<(BattleUnit sUnit, SkillIdentity skill, BattleUnit oUnit)>> BeforeActCmdEventFilter((BattleUnit sUnit, SkillIdentity skill, BattleUnit oUnit) cmdData)
    {
        ...
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.BeforeActCmdEventFilter(buff, cmdData, this),
    ...
    {
        List<ParamFilter<(BattleUnit sUnit, SkillIdentity skill, BattleUnit oUnit)>> filters = new List<ParamFilter<(BattleUnit sUnit, SkillIdentity skill, BattleUnit oUnit)>>();
        filters = makeFilter_BuffAndAbility((buff) => buff.identity.AfterActCmdEventFilter(buff, cmdData, this),
    ...
    {
        return makeFilter_BuffAndAbility((buff) => buff.identity.AfterOneTimeApplyEventFilter(buff, acSkillEfcs, this),
